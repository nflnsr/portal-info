      ...
      <nav className="border-b-[3px] border-gray-300 py-3">
        <div className="mx-auto flex justify-around sm:max-w-screen-xl">
          ...
          >
            ...
            <div className="flex w-full items-center justify-center gap-x-2 px-5 text-2xl md:justify-start">
              <div className="py-2 w-full">
                <input type="search" className="h-8 w-full text-sm px-2 md:hidden" />
              </div>
              <div>
                <CgProfile size={28} className="" />
              </div>
            </div>
            <div className="relative space-y-1.5 px-5 text-justify">
            ...
            <div className="sticky bottom-0 block h-3 w-full bg-stone-100" />
          </div>
        </div>
      </nav>
    </header>
