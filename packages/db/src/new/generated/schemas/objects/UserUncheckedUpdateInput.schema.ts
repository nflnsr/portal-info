...
import { LikeUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from './LikeUncheckedUpdateManyWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateInput> = z
  .object({
    ...
    comment: z
      ...
      .optional(),
    like: z
      .lazy(() => LikeUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict();
