...
import { LikeUpdateManyWithoutUserNestedInputObjectSchema } from './LikeUpdateManyWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutArticleInput> = z
  .object({
    ...
    comment: z
      ...
      .optional(),
    like: z
      .lazy(() => LikeUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict();
