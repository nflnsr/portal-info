...
type ArticleUncheckedUpdateManyWithoutArticleInput = Prisma.ArticleUncheckedUpdateManyWithoutUserInput;

const Schema: z.ZodType<ArticleUncheckedUpdateManyWithoutArticleInput> =
  z
    .object({
      id: z
        .union([
...
export const ArticleUncheckedUpdateManyWithoutArticleInputObjectSchema = Schema;
