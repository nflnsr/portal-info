...
const Schema: z.ZodType<Prisma.LikeUpdateManyWithoutArticleNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => LikeUpsertWithWhereUniqueWithoutArticleInputObjectSchema),
        z
          .lazy(() => LikeUpsertWithWhereUniqueWithoutArticleInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => LikeUpdateWithWhereUniqueWithoutArticleInputObjectSchema),
        z
          .lazy(() => LikeUpdateWithWhereUniqueWithoutArticleInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const LikeUpdateManyWithoutArticleNestedInputObjectSchema = Schema;
