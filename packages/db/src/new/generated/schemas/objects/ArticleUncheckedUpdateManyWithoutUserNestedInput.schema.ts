...
const Schema: z.ZodType<Prisma.ArticleUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ArticleUncheckedCreateWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => ArticleCreateOrConnectWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => ArticleUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => ArticleUpsertWithWhereUniqueWithoutUserInputObjectSchema,
        ...
        .optional(),
      createMany: z
        .lazy(() => ArticleCreateManyUserInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => ArticleUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => ArticleUpdateWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      updateMany: z
        .union([
          ...
          z
            .lazy(() => ArticleUpdateManyWithWhereWithoutUserInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const ArticleUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
