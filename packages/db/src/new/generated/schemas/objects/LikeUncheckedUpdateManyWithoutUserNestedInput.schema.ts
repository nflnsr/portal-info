...
const Schema: z.ZodType<Prisma.LikeUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LikeUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
