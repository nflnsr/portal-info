...
const Schema: z.ZodType<Prisma.CommentUncheckedUpdateManyWithoutArticleNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => CommentUpdateManyWithWhereWithoutArticleInputObjectSchema,
          ),
          z
            .lazy(
              () => CommentUpdateManyWithWhereWithoutArticleInputObjectSchema,
...
export const CommentUncheckedUpdateManyWithoutArticleNestedInputObjectSchema =
  Schema;
